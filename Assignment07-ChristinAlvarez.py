...
#   CAlvarez,1/27/2024,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    def first_name(self)->str:
        ...
        :return: The first name with formatting.
        """
        return self._first_name.title()
    @first_name.setter
    def first_name(self,value:str)->None:
        """
        Sets the first name with validations
        :param value: value to set
        """
        if value.isalpha():
            self._first_name=value
        else:
            raise ValueError("First name must be letters only.")

    @property
    def last_name(self)->str:
        """
        Returns the last_name as a title
        :return: The last name with formatting.
        """
        return self._last_name.title()
    @last_name.setter
    def last_name(self,value:str)->None:
        """
        Sets the last name with validations
        :param value: value to set
        """
        if value.isalpha():
            self._last_name=value
        else:
            raise ValueError("Last name must be letters only.")
